<?php
//fichier appelé par index.php pour la page d'inscription

//lancement et configuration d'une session Smarty
$tpl = new Smarty();
...
//assignation des variables et affichage du template
if(isset($erreur))
